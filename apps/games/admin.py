...
from .models import Game, Genre, Company, Comment , WishList , Order , InviteCard , AdditionalGamesPhotos

MyType: TypeAlias = tuple[tuple[Union[str ,dict[str,list[str]]]]]


class AdditionalGamesPhotosAdmin(admin.ModelAdmin):
...
admin.site.register(AdditionalGamesPhotos, AdditionalGamesPhotosAdmin)
